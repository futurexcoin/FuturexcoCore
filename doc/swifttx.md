...
* WebSocket: [https://github.com/FuturexcoCoin-Core/insight-api-futurexco#web-socket-api](https://github.com/FuturexcoCoin-Core/insight-api-futurexco#web-socket-api)
* API: [https://github.com/FuturexcoCoin-Core/insight-api-futurexco#swifttx-transactions](https://github.com/FuturexcoCoin-Core/insight-api-futurexco#swifttx-transactions)
...
By default, the FuturexcoCoin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the FuturexcoCoin Core daemon:
