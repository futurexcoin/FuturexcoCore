Contributing to FuturexcoCoin Core
============================

The FuturexcoCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the FuturexcoCoin Core project, and is not to be
confused with overall FuturexcoCoin Network Protocol consensus changes.

Whether a pull request is merged into FuturexcoCoin Core rests with the project merge
...
Patches that change FuturexcoCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the FuturexcoCoin consensus, it must have been
...
The project leader is the release manager for each FuturexcoCoin Core release.
