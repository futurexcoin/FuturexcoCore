...
QString windowTitle = tr("FutureXco") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a FTXO address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and FTXO: URIs)"));
...
*/
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About FTXO wallet"), this);
    aboutAction->setStatusTip(tr("Show information about FTXO wallet"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for FTXO wallet"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your FTXO addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(GUIUtil::getThemeImage(":/icons/transaction_0")), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified FTXO addresses"));
    ...
    openAction->setStatusTip(tr("Open a FTXO: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the FTXO help message to get a list with possible FTXO command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("FTXO client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to FTXO network", "", count));
}
...
{
    QString strTitle = tr("FTXO"); // default title
