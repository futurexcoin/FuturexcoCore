...
FuturexcoCoin-Project/FuturexcoCoin repository.
...
Setup
---------
Configuring the github-merge tool for the FuturexcoCoin repository is done in the following way:

    git config githubmerge.repository FuturexcoCoin-Project/FuturexcoCoin
...
A script to optimize png files in the FuturexcoCoin
