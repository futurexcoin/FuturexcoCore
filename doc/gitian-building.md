...
*Setup instructions for a gitian build of FuturexcoCoin using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the FuturexcoCoin
...
- [Building FuturexcoCoin](#building-futurexco)
...
Building FuturexcoCoin
----------------

To build FuturexcoCoin (for Linux, OSX and Windows) just follow the steps under 'perform
